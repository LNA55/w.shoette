# What works for me — Cahier des charges (v3)
...
> Cette v3 consolide tout ce qui a été décidé sur les 3 derniers jours, **y compris des
> fonctions pas encore présentes dans la démo web**. Elle remplace les versions
> précédentes (`cahier-des-charges.md`, `cahier-des-charges-v2.md`).
>
